...
# Description: Building CNN for human vs cartoon binary classification and running prediction.
...
if __name__ == '__main__':
    if os.path.exists('traindata5.npy'):
        train_data = np.load('traindata5.npy')
    else:
    ...
    with open('Task2d.csv', mode='w') as Task2d: # Writing to csv file 
        TaskWriter = csv.writer(Task2d, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
